 ...
 * ClosedShape.java
 *
 * @version 2.0.0 Originally written by Bette Bultena but heavily modified for the purposes of CSC-115 (Daniel Archambault and Liam O'Reilly)
 */
...
/**
 * A ClosedShape is any shape that can be drawn without taking a pencil off a piece of paper. It's representation on computer has a line colour and a position on the drawable screen component. It can
 * be filled in with colour or opaque. This class is a super class for all shapes.
 */
public abstract class ClosedShape {
    ...
    /**
     * Takes in a direction and a velocity and moves the shape in that direction on unit
     */
    public void move() {
        x += xVec;
        y += yVec;
